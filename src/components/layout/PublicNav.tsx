...
export function PublicNav() {
  return (
    <nav className="sticky top-0 z-50 h-[60px] flex items-center justify-between px-[clamp(20px,5vw,56px)] border-b border-border bg-background/90 backdrop-blur-[16px] [-webkit-backdrop-filter:blur(16px)]">
      <Link
        href="/"
