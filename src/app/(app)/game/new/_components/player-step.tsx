...
import { FriendCombobox } from "@/components/friends/friend-combobox";
import { WonderPicker } from "@/components/game/wonder-picker";
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between pt-4">
        <Button variant="outline" onClick={() => setStep(1)}>
          <LucideMoveLeft /> Précédent
        </Button>
        <Button onClick={handleNext}>
          Suivant <LucideMoveRight />
        </Button>
      </div>
    </div>
  );
